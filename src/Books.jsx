...
/* category[0].toUpperCase() is to take the first letter and  capitalize and the use slice(1) to cut the word in two starting from the letter in position 1 'r' so you get 'rogramming', the '+' is use to concatonete "P" and 'rogramming' */im